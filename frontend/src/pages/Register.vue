<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden" :class="{ 'dark-mode': darkMode }">
    ...
    <!-- Register Container -->
    <div class="relative z-40 w-full max-w-md mx-auto p-8">
      <!-- Logo Section -->
      ...
      <!-- Register Form -->
      <div class="card p-6 shadow-2xl bg-white/95 backdrop-blur-sm">
        <form @submit.prevent="handleRegister" class="space-y-6">
          <!-- Full Name Field -->
          <div>
            <label for="fullName" class="block text-sm font-medium mb-2" :class="darkMode ? 'text-white' : 'text-gray-900'">
              Ad Soyad
            </label>
            <input
              id="fullName"
          ...
          <!-- Phone Field -->
          <div>
            <label for="phone" class="block text-sm font-medium mb-2" :class="darkMode ? 'text-white' : 'text-gray-900'">
              Telefon
            </label>
            <input
              id="phone"
          ...
          <div>
            <label for="confirmPassword" class="block text-sm font-medium mb-2" :class="darkMode ? 'text-white' : 'text-gray-900'">
              Şifre Tekrar
            </label>
            <input
              id="confirmPassword"
          ...
          <div class="flex items-start">
            ...
            />
            <label class="ml-2 text-sm" :class="darkMode ? 'text-white' : 'text-gray-900'">
              <a href="#" class="font-medium transition-colors duration-300" :class="darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'">
                Kullanım Şartları
              </a>
              ve
              <a href="#" class="font-medium transition-colors duration-300" :class="darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-500'">
