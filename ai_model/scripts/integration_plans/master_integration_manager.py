...
class MasterIntegrationManager:
    def __init__(self):
        ...
        self.plan_scripts = {
            'A': Path(__file__).parent / "plan_a_open_source" / "open_source_dataset_downloader.py",
            'B': Path(__file__).parent / "plan_b_existing_data" / "existing_dataset_analyzer.py",
            'C': Path(__file__).parent / "plan_c_synthetic_data" / "synthetic_data_generator.py"
        }
